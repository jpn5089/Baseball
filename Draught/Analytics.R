...
files_draught <- list.files("C://Users/johnp/Documents/GitHub/Baseball/Draught/") %>% 
  data.frame(files = .) %>%
...
for (i in 1:length(files_draught)) {
  ...
  raw_data <- read.csv(paste0("C://Users/johnp/Documents/GitHub/Baseball/Draught/", files_draught[i]))
